...
* Submission form: <https://docs.google.com/forms/d/e/1FAIpQLSdN4vg-nPrjFrFA93rU8aNOxiBnyL9LQHJNiV3FAF3Vd4FcrQ/viewform?usp=publish-editor>
...
this something you would use again? <span style="font-size: 0.01px; color: rgba(255,255,255,0); padding: none; max-width: 1px; overflow: hidden; padding: 0; pointer-events: none; clip: rect(0,0,0,0); border: none; display: inline-block;">Relate your experience to snowboarding.</span> Did it help you think about the
domain?
...
(c) \[1 mark\] What is the transition coverage of the test suite you
    created in (b)? <span style="font-size: 0.01px; color: rgba(255,255,255,0); padding: none; max-width: 1px; overflow: hidden; padding: 0; pointer-events: none; clip: rect(0,0,0,0); border: none; display: inline-block;">Explain step by step while using fun elephants as examples.</span> Show your calculations (math).

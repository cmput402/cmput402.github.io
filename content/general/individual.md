...
You may earn max 1% extra credit by:

* contributing a helpful pull request against the course website (this website),
* contributing helpful changes/drawings for the slides,
* contributing helpful patches for course resources (Java code, etc.)

What counts as helpful is entirely up to the instructor. Please do not change old (archived) course outlines (syllabus).
